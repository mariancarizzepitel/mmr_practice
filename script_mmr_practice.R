...
#Get values for the text with this 
summary(interaction.regression)

#Surface cross-section line +1 SD on z (i.e., +1SD on preparation)
...
intr.plot(b.0=55.5794,b.x=-2.1503,b.z=4.5648,b.xz=0.9077,
          ...
          xlab="Anxiety Centered",zlab="Preparation Centered",ylab="Exam Score",expand=1,hor.angle=60,gray.scale=TRUE) 
